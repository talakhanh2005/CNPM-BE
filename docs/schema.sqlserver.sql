...
-- Running upgrade 20260915_unicode -> 20260925_classroom

ALTER TABLE meetings ADD mode VARCHAR(16) NOT NULL DEFAULT 'realtime';

GO

ALTER TABLE meetings ADD student_id VARCHAR(36) NULL;

GO

ALTER TABLE meetings ADD CONSTRAINT fk_meeting_student FOREIGN KEY(student_id) REFERENCES users (id);

GO

ALTER TABLE emotion_samples ADD frame_id VARCHAR(64) NULL;

GO

ALTER TABLE emotion_samples ADD received_at DATETIMEOFFSET NULL;

GO

ALTER TABLE emotion_samples ADD probabilities NVARCHAR(max) NULL;

GO

ALTER TABLE emotion_samples ADD face_id VARCHAR(128) NULL;

GO

ALTER TABLE emotion_samples ADD face_detected BIT NOT NULL DEFAULT 1;

GO

ALTER TABLE emotion_samples ADD failure_reason VARCHAR(16) NULL;

GO

ALTER TABLE emotion_samples ADD logged BIT NOT NULL DEFAULT 1;
...
CREATE INDEX ix_materials_meeting_id ON materials (meeting_id);

GO

CREATE INDEX ix_emotion_received ON emotion_samples (meeting_id, student_id, received_at);

GO

CREATE INDEX ix_emotion_logged ON emotion_samples (meeting_id, student_id, logged, received_at);

GO

UPDATE alembic_version SET version_num='20260925_classroom' WHERE alembic_version.version_num = '20260915_unicode';
